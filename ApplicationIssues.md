#summary Common problems with WSGI applications.
...
In mod\_wsgi 2.0, if using daemon mode the value of the 'HOME' environment
...
If you are unable to upgrade to Apache 2.2 and/or mod\_wsgi 2.0, the only
